...
// Define the type for the loadedData state
type LoadedDataState = SyntheticEvent<HTMLVideoElement, Event>[];
const VideoCarousel = () => {
  ...
  const handleProcess = (type: string, i: string | number) => {
    switch (type) {
      case "video-end":
        setVideo((pre) => ({
          ...pre,
          isEnd: true,
          videoId: (i as number) + 1,
        }));
        break;
